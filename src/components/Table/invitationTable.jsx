...
function InvitationTable(chefData){
         ...
         <div className="w-full">
          ...
          <thead className="bg-[#D89D7240]  rounded-t-[5px]">
              <tr className="grid md:grid-cols-5 grid-cols-5 gap-2 md:gap-1 my-5 text-center">
                ...
                <th className="md:text-xl text-[0.5rem]">Email Address</th>
                <th className="md:text-xl text-[0.5rem]">Phone Number</th>
                <th className="md:text-xl text-[0.5rem] col-span-2 md:col-span-1">
                Number of seats
                </th>
                <th className="md:text-xl text-[0.5rem]">invitation Status</th>
